...
See `_partials/implementation_plan_riddle_readability.md` for the approved-design,
awaiting-implementation plan for multiline riddle and answer-choice readability.
