...
const REVELER_TUNING = {
  ...
  ATTACK_INTERVAL: [[3.4, 4.6], [2.8, 3.8], [1.8, 2.7]],
  ATTACK_WEIGHTS: { formation: 3, shell: 3, scatter: 2, overload: 1 },
  ...
  OVERLOAD: {
    DURATION: [22, 20, 18], NODE_COUNT: 10, NODE_HP: [3, 6], SEPARATION: 3.2,
